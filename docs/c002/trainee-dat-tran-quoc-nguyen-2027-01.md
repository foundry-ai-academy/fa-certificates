...
## Awarded to **Dat Tran Quoc Nguyen**

![Certificate Image](trainee-dat-tran-quoc-nguyen-2027-01.png)

[Download Certificate (PDF) :fontawesome-solid-download:](trainee-dat-tran-quoc-nguyen-2027-01.pdf){ .md-button .md-button--primary }

### Certificate Details
- **Certificate ID**: `FA-C002`
- **Certificate Holder ID**: `FA-C002/trainee-dat-tran-quoc-nguyen-2027-01`
...
### Comments
This certifies that Dat Tran Quoc Nguyen has successfully completed the Data & AI Engineering Course v2 from Foundry AI Academy, having met all academic requirements and demonstrated proficiency, diligence, and commitment to advanced study in Data and AI Engineering.

...
## Awarded to **Lam Ngoc Dinh**

![Certificate Image](trainee-lam-ngoc-dinh-2027-01.png)

[Download Certificate (PDF) :fontawesome-solid-download:](trainee-lam-ngoc-dinh-2027-01.pdf){ .md-button .md-button--primary }

### Certificate Details
- **Certificate ID**: `FA-C002`
- **Certificate Holder ID**: `FA-C002/trainee-lam-ngoc-dinh-2027-01`
...
### Comments
This certifies that Lam Ngoc Dinh has successfully completed the Data & AI Engineering Course v2 from Foundry AI Academy, having met all academic requirements and demonstrated proficiency, diligence, and commitment to advanced study in Data and AI Engineering.
